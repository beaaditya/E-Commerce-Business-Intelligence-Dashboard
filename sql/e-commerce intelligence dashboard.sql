...
COPY customers_dataset FROM 'C:\olist\archive\customers_dataset.csv' DELIMITER ',' CSV HEADER;

COPY geolocation_dataset FROM 'C:\olist\archive\geolocation_dataset.csv' DELIMITER ',' CSV HEADER;

COPY products_dataset FROM 'C:\olist\archive\products_dataset.csv' DELIMITER ',' CSV HEADER;

COPY sellers_dataset FROM 'C:\olist\archive\sellers_dataset.csv' DELIMITER ',' CSV HEADER;

COPY orders_dataset FROM 'C:\olist\archive\orders_dataset.csv' DELIMITER ',' CSV HEADER;

COPY order_items_dataset FROM 'C:\olist\archive\order_items_dataset.csv' DELIMITER ',' CSV HEADER;

COPY order_payments_dataset FROM 'C:\olist\archive\order_payments_dataset.csv' DELIMITER ',' CSV HEADER;

COPY order_reviews_dataset FROM 'C:\olist\archive\order_reviews_dataset.csv' DELIMITER ',' CSV HEADER;

COPY product_category_name_translation FROM 'C:\olist\archive\product_category_name_translation.csv' DELIMITER ',' CSV HEADER;

select* from geolocation_dataset;
TRUNCATE TABLE geolocation_dataset;
-- Orders
...
LEFT JOIN order_payments_dataset p ON p.order_id = oi.order_id
LEFT JOIN sellers_dataset s ON s.seller_id = oi.seller_id;
